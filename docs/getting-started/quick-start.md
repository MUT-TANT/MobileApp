...
StackSave requires a crypto wallet to function. Don't have one? See [Wallet Setup](quick-start.md#wallet-setup) below.
...
**Q: Do I need cryptocurrency?** A: Yes, StackSave works with crypto wallets. You'll need some ETH (or supported tokens) to start saving.

**Q: Is my money safe?** A: Yes! StackSave never holds your funds. Everything stays in your wallet under your control.

**Q: Can I withdraw anytime?** A: Absolutely! You have complete control and can withdraw whenever you want.

**Q: What if I don't reach my goal?** A: No problem! Goals are flexible. You can extend the deadline, adjust the target, or withdraw what you've saved.

**Q: Are there fees?** A: StackSave itself is free. You only pay standard blockchain gas fees for transactions.
...
**Need help?** Check out our [detailed guides](connecting-wallet.md) or [FAQ](../resources/faq.md).
